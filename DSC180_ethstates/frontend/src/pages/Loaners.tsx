import {
  ...
  import LoanerCard from "../components/property/LoanerCard";
  import LoanerCollection from "../components/property/LoanerCollection";
  ...
  export default function Marketplace() {
    ...
    const [loaners, setLoaner] = useState<Loaner[] | undefined>([]);
